...
import { ArrowLeft, Mail, Lock, Eye, EyeOff, Flame } from "lucide-react";
    ...
    >
      ...
      <div className="mt-10 flex flex-col gap-5">
        ...
        <button 
          ...
          className="w-full bg-[#0F5B5B] text-white font-medium rounded-full py-4 mt-2 hover:bg-[#0B4444] transition-colors shadow-md"
        >
          Log In
        </button>
      </div>
